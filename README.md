...
#### 或从源码构建
```bash
git clone https://github.com/erpan/agent-debugger.git
cd agent-debugger
npm install
...
<a href="https://github.com/erpan/agent-debugger/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=erpan/agent-debugger" />
</a>
...
- 作者: Erpan
- GitHub: [@erpan](https://github.com/erpan)
- Email: erpan@example.com
